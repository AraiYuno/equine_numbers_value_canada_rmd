...
bibliography: r_packages_ref.bib
...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Population of Canadian Horses in All Provinces between 1940~1972", out.width = "100%"}
...
kable(
  max_horses,
  caption = "Table 1. Maximum and minimum number of horses in each province between 1940 ~ 1972"
)
```

Below we zoom in and look at the province of \`r params$province\`\`:

```{r plot province, fig.width=5, fig.height=4, fig.cap = "Number of Horses", out.width = "50%"}
